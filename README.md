...
> 즉, “전자결재 시스템의 핵심 구조와 DB는 전부 설계했고, 결재 상신 기능은 직접 개발”

---

## 🟩 공통문서 관리 시스템 (100% 개인 개발)
- 문서 분류/검색/조회 기능 개발  
- 권한 기반 접근 제어(Role/Permission) 개발  
- **대량 파일 업로드/다운로드 처리 로직 직접 구현**  
- Docker 파일 경로 문제 해결(컨테이너 경로 매핑)  
- 문서/파일 관련 테이블 설계 전체 담당  
